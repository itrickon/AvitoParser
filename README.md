...
- Если хотите найти объявления, то запустите **search_ads_avito.py** и в функции main напишите город(city) в котором хотите искать и слово(kword) - что искать.
- Если хотите найти номера в полученных объявлениях, то запустите **phone_search_avito**, и в main измените input_file, вставьте название своего файла с расширением(.xlsx)  
- Полученный результат из phone_search_avito можно декодировать в **decode_photos**.py, чтобы получшить .xlsx файл  
